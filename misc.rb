...
class Player
  ...
  def check_split
    if self.hand[0] == self.hand[1]
      return true
    elsif ["10", "J", "Q", "K"].include? self.hand[0] and ["10", "J", "Q", "K"].include? self.hand[0]
      return true
    else
      return false
    end
  ...
  def get_player_action
    while true
      ...
      if player_action == "1" or player_action == "hit me"
        ...
        puts "Please select option 1 or 2." if !player.check_split
        puts "Please select option 1, 2, or 3." if player.check_split
      end
    end
  end
...
while true
  ...
  #player.new_hand deck.draw_card, deck.draw_card #put back in after adding split!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  player.new_hand "K", "J"
  ...
  while true
    ...
    if player.hand_total == 21
      ...
      puts "1. Hit Me"
      puts "2. Stay"
      puts "3. Split" if player.check_split
